...
('234abc231', 'Ramanuj', '2000-02-21', '21/694, krishnamai Apartment, Refinery Road, belagavi', 590001, 'Belagavi', 9016636683);
...
(10002, 'Dev', 'Laxman', 'sharma', 'M', '2022-10-02', '21/695, Satyam Apartment, Refinery Road, belagavi', 590001, 9016636683, 'Harsha sharma', 'A', 'Ram sharma', 'A', 'S', '');
...
(325256815, '2021-10-31', 123564789),
(325284137, '2019-11-01', 284049583),
(325289940, '2020-11-01', 123564789);
...
(123564789, 10002, '234abc231', '2021-10-02', 'Jeevan Labh', 35000, 5, 10),
(284049583, 10002, '234abc231', '2015-06-20', 'Jeevan Lakshya', 450000, 35, 80);
...
(123564789, 3500, 'YLY', '2021-12-01'),
(284049583, 469, 'MLY', '2015-12-01');
...
--
ALTER TABLE `customer`
  MODIFY `Customer_Num` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
